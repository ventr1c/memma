...
CONFIG_PATH="$EXPERIMENT_ROOT/configs/memory_toolkits/amem_locomo_gpt4omini.json"
...
RUN_DIR="$RESULTS_ROOT/amem_locomo_gpt4omini_${TIMESTAMP}"
TOKEN_COST_PREFIX="$RUN_DIR/token_cost_amem"
mkdir -p "$RUN_DIR"

echo "[INFO] Running A-MEM baseline"
...
echo "[DONE] A-MEM baseline completed."
