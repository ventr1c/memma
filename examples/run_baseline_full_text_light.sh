...
CONFIG_PATH="$EXPERIMENT_ROOT/configs/memory_toolkits/fullcontext_locomo_gpt4omini.json"
...
RUN_DIR="$RESULTS_ROOT/fullcontext_locomo_gpt4omini_${TIMESTAMP}"
TOKEN_COST_PREFIX="$RUN_DIR/token_cost_fullcontext"
mkdir -p "$RUN_DIR"

echo "[INFO] Running FullContext baseline"
...
echo "[DONE] FullContext baseline completed."
