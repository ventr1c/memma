...
CONFIG_PATH="$EXPERIMENT_ROOT/configs/memory_toolkits/langmem_locomo_gpt4omini.json"
...
RUN_DIR="$RESULTS_ROOT/langmem_locomo_gpt4omini_${TIMESTAMP}"
TOKEN_COST_PREFIX="$RUN_DIR/token_cost_langmem"
mkdir -p "$RUN_DIR"

echo "[INFO] Running LangMem baseline"
...
echo "[DONE] LangMem baseline completed."
