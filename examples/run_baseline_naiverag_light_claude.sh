...
CONFIG_PATH="$EXPERIMENT_ROOT/configs/memory_toolkits/naiverag_locomo_claude_haiku.json"
...
RUN_DIR="$RESULTS_ROOT/naiverag_locomo_claude-haiku_${TIMESTAMP}"
TOKEN_COST_PREFIX="$RUN_DIR/token_cost_naiverag"
mkdir -p "$RUN_DIR"

echo "[INFO] Running NaiveRAG baseline (Claude)"
...
echo "[DONE] NaiveRAG baseline (Claude) completed."
